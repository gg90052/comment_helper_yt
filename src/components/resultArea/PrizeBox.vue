<template>
  <div class="bg-white border p-4 mb-2 relative">
    ...
    <div class="grid grid-cols-[300px_1fr] mt-2 mobile:grid-cols-1">
      ...
      <div class="flex items-start flex-wrap ml-4 mobile:mt-4 mobile:ml-0">
        <div @click="editPrize(index)" class="px-2 py-2 m-1 text-white bg-blue-500 flex items-center cursor-pointer mobile:m-2" v-for="(prize, index) in dataStore.prizeList">
